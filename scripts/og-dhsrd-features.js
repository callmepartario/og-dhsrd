...
{ label: "Jagged Knife Sniper", name: "jagged-knife-sniper'", tier: 1, type: "Ranged", pages: ["Page 214"], summary: "A lanky bandit striking from cover with a shortbow.", motive: "Ambush, hide, profit, reposition", difficulty: 13, thresholdmajor: 4, thresholdsevere: 7, hp: 3, hphorde: 0, stress: 2, attackbonus: -1, attacklabel: "Shortbow", attackrange: "Far", attackdamage: "1d10+2", attackdamagetype: "phy", experiences: ["Stealth +2"], features: ["<p><strong><em>Unseen Strike&mdash;Passive:</em></strong> If the Sniper is <a href='#define-condition'><em>Hidden</em></a> when they make a successful standard attack against a target, they deal <strong>1d10+4</strong> <a href='#define-damage-type'>physical damage</a> instead of their standard damage.</p>"], category: "Person" },
